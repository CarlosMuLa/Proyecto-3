...
play(ALLEGRO_DISPLAY*display, ALLEGRO_EVENT_QUEUE*queue, ALLEGRO_TIMER*timer,ALLEGRO_FONT*font, ALLEGRO_MOUSE_CURSOR*cursor, ALLEGRO_BITMAP*fondo, ALLEGRO_SAMPLE_INSTANCE*click)
{
	bool playing = true;
	while (playing)
	{
